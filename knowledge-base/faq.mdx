...
If you are self-hosting Coolify, you can simply set it after you installed Coolify on the `localhost` server.
  ...
  <Accordion title="Increase Concurrent Builds">
   ...
   <Accordion title="Coolify Cloud Public IPs">
...
<AccordionGroup>
  <Accordion title="How to map a port the server?">
    If you want to map a port the host system (server), you need to use [Ports
    Mappings](/knowledge-base/applications#port-mappings) feature.
  </Accordion>
</AccordionGroup>
