...
"og:title": "How to configure database backups in Coolify"
...
<Tip>Coolify own database is also backed up using this method.</Tip>
...
You can also define your own [S3 compatible](./s3/index) storage to store your backups.
