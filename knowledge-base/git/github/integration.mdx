---
title: "Integration"
"og:title": "How to use GitHub based Git deployments."
...
<Tip>You can only use the https URL.</Tip>
...
<Tip>You need to use the SSH URL, so the one that starts with `git@`.</Tip>
